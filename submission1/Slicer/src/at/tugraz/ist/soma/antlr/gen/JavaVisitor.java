...
public interface JavaVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link JavaParser#compoundIfStmt}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitCompoundIfStmt(JavaParser.CompoundIfStmtContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link JavaParser#elseStmt}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitElseStmt(JavaParser.ElseStmtContext ctx);
	/**
